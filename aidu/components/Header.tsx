        ...
        <div className="w-full h-8 p-4 justify-between items-center lg:flex-row">
            <div className="h-full flex flex-row items-center justify-between p-2">
                ...
                <div className="sm:flex flex-row gap-2 hidden">
                    ...
                    <button className="nav-element" onClick={toggleSolutionMenu}>Solutions</button>
                ...
                <motion.div
                    ...
                    <a href="/about" className="nav-element text-3xl">About</a>
                    <button className="nav-element text-3xl" onClick={toggleSolutionMenu}>Solutions</button>
                    <a href="/contact" className="nav-element text-3xl">Contact</a>
                </motion.div>
